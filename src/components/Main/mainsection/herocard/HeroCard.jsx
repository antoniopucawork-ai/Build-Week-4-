...
// isOwnProfile indica se sto visualizzando il mio profilo
// oppure quello di un altro utente.
// fetchProfile aggiorna i dati dopo una modifica.
          ...
          <div className="hero-actions row g-2 align-items-center">
            <div className="col-12 col-md-auto">
              <div className="d-flex justify-content-between align-items-center gap-2">
                <LinkedinButton
                  customVariant={BUTTON_VARIANT.MAIN.AVAILABLE}
